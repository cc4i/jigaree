...
type CityWeatherResponse struct {
	...
	Localtime     int64   `protobuf:"varint,5,opt,name=localtime,proto3" json:"localtime,omitempty"`
	...
	WindKph       float64 `protobuf:"fixed64,10,opt,name=windKph,proto3" json:"windKph,omitempty"`
	WindDegree    float64 `protobuf:"fixed64,11,opt,name=windDegree,proto3" json:"windDegree,omitempty"`
	WindDir       string  `protobuf:"bytes,12,opt,name=windDir,proto3" json:"windDir,omitempty"`
	PressureMb    float64 `protobuf:"fixed64,13,opt,name=pressureMb,proto3" json:"pressureMb,omitempty"`
	PressureIn    float64 `protobuf:"fixed64,14,opt,name=pressureIn,proto3" json:"pressureIn,omitempty"`
	PrecipMm      float64 `protobuf:"fixed64,15,opt,name=precipMm,proto3" json:"precipMm,omitempty"`
	PrecipIn      float64 `protobuf:"fixed64,16,opt,name=precipIn,proto3" json:"precipIn,omitempty"`
	Humidity      float64 `protobuf:"fixed64,17,opt,name=humidity,proto3" json:"humidity,omitempty"`
	Cloud         float64 `protobuf:"fixed64,18,opt,name=cloud,proto3" json:"cloud,omitempty"`
	FeelslikeC    float64 `protobuf:"fixed64,19,opt,name=feelslikeC,proto3" json:"feelslikeC,omitempty"`
	VisKm         float64 `protobuf:"fixed64,21,opt,name=visKm,proto3" json:"visKm,omitempty"`
	Uv            float64 `protobuf:"fixed64,23,opt,name=uv,proto3" json:"uv,omitempty"`
	GustKph       float64 `protobuf:"fixed64,24,opt,name=gustKph,proto3" json:"gustKph,omitempty"`
}
...
func (x *CityWeatherResponse) GetLocaltime() int64 {
	if x != nil {
		return x.Localtime
	}
	return 0
...
func (x *CityWeatherResponse) GetLastUpdate() int64 {
	if x != nil {
		return x.LastUpdate
	}
	return 0
...
func (x *CityWeatherResponse) GetWindKph() float64 {
	if x != nil {
		return x.WindKph
	}
	return 0
...
func (x *CityWeatherResponse) GetWindDegree() float64 {
	if x != nil {
		return x.WindDegree
	}
	return 0
...
func (x *CityWeatherResponse) GetPressureMb() float64 {
	if x != nil {
		return x.PressureMb
	}
	return 0
...
func (x *CityWeatherResponse) GetPressureIn() float64 {
	if x != nil {
		return x.PressureIn
	}
	return 0
...
func (x *CityWeatherResponse) GetPrecipMm() float64 {
	if x != nil {
		return x.PrecipMm
	}
	return 0
...
func (x *CityWeatherResponse) GetPrecipIn() float64 {
	if x != nil {
		return x.PrecipIn
	}
	return 0
...
func (x *CityWeatherResponse) GetHumidity() float64 {
	if x != nil {
		return x.Humidity
	}
	return 0
...
func (x *CityWeatherResponse) GetCloud() float64 {
	if x != nil {
		return x.Cloud
	}
	return 0
...
func (x *CityWeatherResponse) GetFeelslikeC() float64 {
	if x != nil {
		return x.FeelslikeC
	}
	return 0
...
func (x *CityWeatherResponse) GetVisKm() float64 {
	if x != nil {
		return x.VisKm
	}
	return 0
...
func (x *CityWeatherResponse) GetUv() float64 {
	if x != nil {
		return x.Uv
	}
	return 0
...
func (x *CityWeatherResponse) GetGustKph() float64 {
	if x != nil {
		return x.GustKph
	}
	return 0
...
var file_weather_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x1e,
	0x0a, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x24,
	...
	0x6e, 0x64, 0x4b, 0x70, 0x68, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x77, 0x69, 0x6e,
	0x64, 0x4b, 0x70, 0x68, 0x12, 0x1e, 0x0a, 0x0a, 0x77, 0x69, 0x6e, 0x64, 0x44, 0x65, 0x67, 0x72,
	0x65, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x77, 0x69, 0x6e, 0x64, 0x44, 0x65,
	...
	,
