...
func (in *AirSpec) DeepCopyInto(out *AirSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AirSpec.
func (in *AirSpec) DeepCopy() *AirSpec {
	if in == nil {
		return nil
	}
	out := new(AirSpec)
